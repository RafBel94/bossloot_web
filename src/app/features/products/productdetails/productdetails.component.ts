...
export class ProductdetailsComponent {
  ...
  createProductWithSpecs(product: any) {
    switch (product.category_id) {
      case 1:
        return new RamProduct(product.name, product.description, product.category_id, product.brand_id, product.model, product.price, product.quantity, product.on_offer, product.deleted, product.discount, product.featured, product.image, product.specs.speed, product.specs.memory, product.specs.memory_type, product.specs.latency);
      case 2:
        return new GpuProduct(product.name, product.description, product.category_id, product.brand_id, product.model, product.price, product.quantity, product.on_offer, product.deleted, product.discount, product.featured, product.image, product.specs.memory, product.specs.memory_type, product.specs.core_clock, product.specs.boost_clock, product.specs.consumption, product.specs.length);
      case 3:
        return new CpuProduct(product.name, product.description, product.category_id, product.brand_id, product.model, product.price, product.quantity, product.on_offer, product.deleted, product.discount, product.featured, product.image, product.specs.socket, product.specs.core_count, product.specs.thread_count, product.specs.base_clock, product.specs.boost_clock, product.specs.consumption, product.specs.integrated_graphics);
      case 4:
        return new MotherboardProduct(product.name, product.description, product.category_id, product.brand_id, product.model, product.price, product.quantity, product.on_offer, product.deleted, product.discount, product.featured, product.image, product.specs.socket, product.specs.chipset, product.specs.form_factor, product.specs.memory_max, product.specs.memory_slots, product.specs.memory_type, product.specs.memory_speed, product.specs.sata_ports, product.specs.m_2_slots, product.specs.pcie_slots, product.specs.usb_ports, product.specs.lan, product.specs.audio, product.specs.wifi, product.specs.bluetooth);
      case 5:
        return new StorageProduct(product.name, product.description, product.category_id, product.brand_id, product.model, product.price, product.quantity, product.on_offer, product.deleted, product.discount, product.featured, product.image, product.specs.type, product.specs.capacity, product.specs.rpm, product.specs.read_speed, product.specs.write_speed);
      case 6:
        return new PsuProduct(product.name, product.description, product.category_id, product.brand_id, product.model, product.price, product.quantity, product.on_offer, product.deleted, product.discount, product.featured, product.image, product.specs.efficiency_rating, product.specs.wattage, product.specs.modular, product.specs.fanless);
      case 7:
      ...
      case 8:
        return new CoolerProduct(product.name, product.description, product.category_id, product.brand_id, product.model, product.price, product.quantity, product.on_offer, product.deleted, product.discount, product.featured, product.image, product.specs.type, product.specs.fan_rpm, product.specs.consumption, product.specs.socket_support, product.specs.width, product.specs.height);
      case 9:
      ...
      case 10:
        return new KeyboardProduct(product.name, product.description, product.category_id, product.brand_id, product.model, product.price, product.quantity, product.on_offer, product.deleted, product.discount, product.featured, product.image, product.specs.type, product.specs.switch_type, product.specs.width, product.specs.height, product.specs.weight);
      case 11:
