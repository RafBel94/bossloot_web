...
export class ProductdetailsComponent {
  ...
  createProductWithSpecs(product: any) {
    switch (product.category) {
      case 'ram':
        return new RamProduct(product.name, product.description, product.category, product.model, product.brand, product.price, product.quantity, product.on_offer, product.discount, product.featured, product.image, product.points, product.specs.speed, product.specs.memory, product.specs.memory_type, product.specs.latency);
      case 'gpu':
